     ...
     <div class="clearfix theme_page relative home_ser div_box_enlish"> 
      ...
      <div class="clearfix"> 
       ...
       <div class="ser_box_img "> 
        <div class="title">
         <a target="_blank" href="#" title="基础科研">基础科研</a>
        </div> 
        <div class="intro">
         <a target="_blank" href="#" title="基础科研"><img src="/uploads/news/ebioservice-e396ff9a73.jpg" alt="基础科研" /></a>
        </div> 
       </div> 
	   
       <div class="ser_box_img "> 
        <div class="title">
         <a target="_blank" href="#" title="药物研发">药物研发</a>
        </div> 
        <div class="intro">
         <a target="_blank" href="#" title="药物研发"><img src="/uploads/news/ebioservice-245d31b173.jpg" alt="药物研发" /></a>
        </div> 
       </div> 
	   
       <div class="ser_box_img "> 
        <div class="title">
         <a target="_blank" href="#" title="动植物、微生物研究">动植物、微生物研究</a>
        </div> 
        <div class="intro">
         <a target="_blank" href="#" title="动植物、微生物研究"><img src="/uploads/news/ebioservice-63819e18d4.jpg" alt="动植物、微生物研究" /></a>
        </div> 
       </div> 
	   
       <div class="ser_box_img "> 
        <div class="title">
         <a target="_blank" href="#" title="临床医学">临床医学</a>
        </div> 
        <div class="intro">
         <a target="_blank" href="#" title="临床医学"><img src="/uploads/news/ebioservice-7b787bbd77.jpg" alt="临床医学" /></a>
        </div> 
       </div> 
	   
       <div class="ser_box_img last"> 
        <div class="title">
         <a target="_blank" href="#" title="遗传与健康">遗传与健康</a>
        </div> 
        <div class="intro">
         <a target="_blank" href="#" title="遗传与健康"><img src="/uploads/news/ebioservice-e52ce2dd45.jpg" alt="遗传与健康" /></a>
        </div> 
       </div> 
      ...
      <div class="clearfix"> 
       ...
       <div class="last ser_box"> 
        ...
        <div class="intro"> 
         <div class="con"> 
          <div style="height: 27px;overflow: hidden;">
           <a target="_blank" href="/product/list/120.html" title="生物信息学分析服务" class="ie6png">生物信息学分析服务</a>
          </div> 
