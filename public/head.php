...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head> 
  ...
  <!-- Le styles --> 
  <link rel="stylesheet" type="text/css" href="<?php echo $site_url;?>/css/reset.css?v=20131018" /> 
  <link rel="stylesheet" href="<?php echo $site_url;?>/css/superfish.css" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo $site_url;?>/css/slider.css?v=20131018" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo $site_url;?>/css/style.css?v=20131018" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo $site_url;?>/css/responsive.css?v=20131018" /> 
  <link rel="stylesheet" href="<?php echo $site_url;?>/css/js_composer_front.css" type="text/css" media="screen" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo $site_url;?>/css/prettyPhoto.css" /> 
  <script type="text/javascript" src="<?php echo $site_url;?>/js/jquery-1.8.2.min.js"></script> 
  <script type="text/javascript" src="<?php echo $site_url;?>/js/s.js"></script> 
  <script type="text/javascript" src="<?php echo $site_url;?>/js/jquery.prettyPhoto.js"></script> 
  <link type="text/css" rel="stylesheet" href="<?php echo $site_url;?>/css/biobox.css" /> 
  <script type="text/javascript" src="<?php echo $site_url;?>/js/biobox.js"></script> 
  <script type="text/javascript" src="<?php echo $site_url;?>/js/jquery.uploadify.v2.1.4.min.js"></script> 
  <!--[if IE 6]>
	<script type="text/javascript" src="<?php echo $site_url;?>/js/DD_belatedPNG.js?v=20130220"></script>
     ...
     <div class="header clearfix"> 
      ...
      <div class="header_right clearfix"> 
       <div class="page-info"> 
        ...
        <span class="loginDIV"> <a href="<?php echo $site_url;?>/login/index.html" title="登录">登录</a> <span>|</span> <a href="<?php echo $site_url;?>/login/register.html" title="注册">注册 </a> </span> 
