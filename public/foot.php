     ...
     <div class="footer_box_container clearfix" style="padding-bottom: 30px;"> 
      ...
      <div class="widget footer_box fx_online"> 
       ...
       <ul class="list-div"> 
        ...
        <li> 
         <div class="fx_img">
          <img src="<?php echo $site_url;?>/images/s-gray.png" />
         </div> 
         <div class="con"> 
          <div class="title">
        ...
        <li class="last"> 
         <div class="fx_img">
          <img src="<?php echo $site_url;?>/images/online-gray.png" />
         </div> 
         <div class="con"> 
          <div class="title">
      ...
      <div class="widget footer_box last emialDIV" style="padding-right: 0;margin-right: 0;"> 
       ...
       <div class="emial-div clearfix"> 
        <form id="sub-form" method="post" action="<?php echo $site_url;?>/public/subscribe.php"> 
    ...
    <div class="footer"> 
     <div class="copyright_area clearfix"> 
      <div class="copyright_left">
	   ...
	   <a href="http://www.miibeian.gov.cn/" target="_blank" class="text">豫ICP备16030033号-1</a> | 
	   <a href="about.php#certificate" target="_blank" class="text">营业执照</a>
	   <br>
      </div> 
  ...
  <script type="text/javascript" src="<?php echo $site_url;?>/js/slider.js"></script> 
  <script type="text/javascript">
		//mobile menu
